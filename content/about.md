...
- {{< marginpar >}}2026{{< /marginpar >}}"*[Beyond Imbalances: A Competition-Theoretic Account of the U.S.-China Rivalry](/documents/TRENARD2026_BeyondImbalances.pdf)*", master thesis for the completion of the Master in the Political Economy of Capitalism at the University of Geneva. Investigated the relationship between exposition to Chinese importations and profitability at the firm level for U.S. firms. (Project Graded 6/6)
- {{< marginpar >}}2025{{< /marginpar >}}"*[Measuring Global Value Chains Integration Using Embodied Labour](/documents/TRENARD2025_MeasuringGVCs.pdf)*", seminar paper for the course "*Global Sustainability*" at Universitat de Barcelona, under ther supervision of Prof. Mònica Serrano. Investigated the labor contribution relative to final demand of different sectors/countries using inter-country input-output (ICIO) tables. (Project Graded 10/10)
